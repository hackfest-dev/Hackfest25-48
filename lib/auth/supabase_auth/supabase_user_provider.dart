...
class Hackfest25SupabaseUser extends BaseAuthUser {
  Hackfest25SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> hackfest25SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Hackfest25SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
