...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: FirstIntroWidget.routeName,
          path: FirstIntroWidget.routePath,
          builder: (context, params) => FirstIntroWidget(),
        ),
        FFRoute(
          name: SecondintropageWidget.routeName,
          path: SecondintropageWidget.routePath,
          builder: (context, params) => SecondintropageWidget(),
        ),
        FFRoute(
          name: ThirdintropageWidget.routeName,
          path: ThirdintropageWidget.routePath,
          builder: (context, params) => ThirdintropageWidget(),
        ),
        FFRoute(
